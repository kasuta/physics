...
\begin{itembox}[l]{\textbf{〇等加速度直線運動}}
	...
	\left(
	\begin{array}{ll}
		\text{⓪} \quad a = \textcolor{red}{a}& \\
		\text{①} \quad v = \textcolor{red}{v_0+at}& \\
		\text{②} \quad x = \textcolor{red}{v_0t + \frac{1}{2}at^2}& \\
...
\begin{itembox}[l]{\textbf{〇鉛直投げ下ろし}}
	\begin{minipage}[t]{0.70\linewidth}
		...
		\left(
		\begin{array}{ll}
			\text{⓪} \quad a = \textcolor{red}{+g}& \\
			\text{①} \quad v = \textcolor{red}{v_0+gt}& \\
			\text{②} \quad y = \textcolor{red}{v_0t + \frac{1}{2}gt^2}& \\
...
\begin{itembox}[l]{\textbf{〇水平投射}}
	\begin{minipage}[t]{0.60\linewidth}
		...
		\begin{array}{ll}
			...
			\text{①} \quad v_x = \textcolor{red}{v_{0x}}& \\
			\text{②} \quad x = \textcolor{red}{v_{0x}t}& 
		\end{array}
		\right.
		\]
		\normalsize
		...
		\begin{array}{ll}
			...
			\text{①} \quad v_y = \textcolor{red}{v_{0y} + gt}& \\
			\text{②} \quad y = \textcolor{red}{v_{0y}t + \frac{1}{2}gt^2}&
		\end{array}
		\right.
		\]
		\normalsize
	...
	\begin{shadebox}
		特徴：\\
		\textcolor{red}{$x$方向は等速直線運動、$y$方向は自由落下である。...}
		\\\\\\\\\\\\\\
	\end{shadebox}
\end{itembox}
...
\begin{itembox}[l]{\textbf{〇斜方投射}}
	\begin{minipage}[t]{0.50\linewidth}
		...
		\begin{array}{ll}
			\text{⓪} \quad a_y = \textcolor{red}{-g}& \\
			\text{①} \quad v_y = \textcolor{red}{- gt}& \\
			\text{②} \quad y = \textcolor{red}{- \frac{1}{2}gt^2}&
		\end{array}
		\right.
		\]
		\normalsize
	...
	\begin{shadebox}
		特徴：\\
		\textcolor{red}{$v_{0x} = v_0\cos\theta, v_{0y} = v_0\sin\theta$である。...}
		\\\\\\\\\\\\\\
	\end{shadebox}
\end{itembox}
